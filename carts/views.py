...
def add_cart(request, product_id):
    ...
    if is_cart_item_exists:
        ...
        if product_variation in ex_var_list:
            ...
            if len(product_variation) > 0: #                variation
                item.variations.clear() # ligne efface toutes les variations précédemment associées à l'élément du panier.
                item.variations.add(*product_variation) #  variation
            item.save()
    else:
        ...
        if len(product_variation) > 0: #                variation
            ...
            cart_item.variations.add(*product_variation) #  variation
        cart_item.save()
